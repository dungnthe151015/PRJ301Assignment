                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <ul class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item">Sủa thông tin của vị trí nhân sự</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-md-12" >
                                    <form action="update" method="POST">
                                        ...
                                        <table class="table table-striped" style="border: 1px solid black;">
                                            <tr>
                                                <th scope="row">Tên vị trí nhân sự: </th>
                                                <td><input style="border: 1px solid black;" value="${et.getEmployeeTypeName()}" name="name" type="text" class="form-control" placeholder="Tên vị trí nhân viên" aria-describedby="basic-addon1"></td>
                                            </tr>
                                        </table>
