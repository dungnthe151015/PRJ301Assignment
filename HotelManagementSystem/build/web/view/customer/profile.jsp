            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Giới tính</td>
                            <td>${customer.isStatus() == true ? "Nam" : "Nữ"}</td>
                        </tr>
                        <tr>
                            <td>Địa chỉ</td>
                        ...
                        <button type="button" class="btn btn-dark justify-content-center"><a href="../customer/edit_profile" style="color: white;">Sửa</a></button>
