                    ...
                    <ul class="nav pcoded-inner-navbar">
                        ...
                        <li class="nav-item pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li class=""><a href="list" class="">Khách hàng</a></li>
                                <li class=""><a href="../payment/list" class="">Hoá đơn</a></li>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <ul class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="list">Quản lý các khách hàng</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="table table-hover m-b-0">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th><span>Tên</span></th>
                                                                <th><span>Ảnh</span></th>
                                                                <th><span>Số chứng minh thư</span></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><%=(i + 1)%></td>
                                                                <td><%=list.get(i).getAccountid().getDisplayName() %></td>
                                                                <td><img src="../img/<%=list.get(i).getImage()%>" style="width: 40px;height: 40px;"></td>
                                                                <td><%=list.get(i).getIDProof() %></td>
                                                                <td><%=list.get(i).isGender() == true ? "Nam" : "Nữ"%></td>
                                                                <td><%=list.get(i).getEmail()%></td>
                                                                <td><%=list.get(i).getPhone()%></td>
                                                                <td><%=list.get(i).getAddress() %></td>
                                                                <td><%=list.get(i).isStatus() == true ? "Còn hoạt động":"Không còn hoạt động" %></td>
                                                            </tr>
                                                            <%
                                                                }
                                                            %>
