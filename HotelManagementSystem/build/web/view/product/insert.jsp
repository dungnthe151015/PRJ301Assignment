                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <ul class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="insert">Thêm sản phẩm mới</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="insert" method="POST">
                                        <table class="table table-striped" style="border: 1px solid black;">
                                            <tr>
                                                ...
                                                <td><input style="border: 1px solid black;" name="name" type="text" class="form-control" placeholder="Tên sản phẩm" aria-describedby="basic-addon1"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Giá: </th>
                                                <td><input style="border: 1px solid black;" name="price" type="text" class="form-control" placeholder="Giá" aria-describedby="basic-addon1"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Sản phẩm thuộc loại: </th>
                                                <td><select name="producttype">
                                                        <c:forEach items="${list}" var="pt">
                                                            <option value="${pt.getID()}">${pt.getProductTypeName()}</option>
                                                        </c:forEach>
                                            ...
                                            <tr>
                                                ...
                                                <td><input style="border: 1px solid black;" name="quantity" type="text" class="form-control" placeholder="Số lượng" aria-describedby="basic-addon1"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Mô tả chi tiết: </th>
                                                <td><input style="border: 1px solid black;" name="description" type="text" class="form-control" placeholder="Mô tả chi tiết" aria-describedby="basic-addon1"></td>
                                            </tr>
                                        </table>
