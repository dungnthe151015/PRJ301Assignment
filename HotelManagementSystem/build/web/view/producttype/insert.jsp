                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <ul class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="insert">Thêm thể loại sản phẩm</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-md-12" >
                                    <form action="insert" method="POST">
                                        <table class="table table-striped" style="border: 1px solid black;">
                                            <tr>
                                                <th scope="row">Tên thể loại sản phẩm: </th>
                                                <td><input style="border: 1px solid black;" name="name" type="text" class="form-control" placeholder="Tên thể loại sản phẩm" aria-describedby="basic-addon1"></td>
                                            </tr>
                                        </table>
