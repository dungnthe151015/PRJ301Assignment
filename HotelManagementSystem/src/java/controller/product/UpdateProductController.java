...
public class UpdateProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        product = new ProductDBContext().getOne(productID);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        producType = new ProductTypeDBContext().getOne(producttype);
        Product product = new Product(ID, name, price, producType, quantity, description, true);
        new ProductDBContext().update(product);
