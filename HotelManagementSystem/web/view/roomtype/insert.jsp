                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="page-header-title">
                                                    <h5>Thể loại phòng</h5>
                                                </div>
                                                <ul class="breadcrumb">
                                                    <li class="breadcrumb-item"><a href="../admin/home"><i class="feather icon-home"></i></a></li>
                                                    <li class="breadcrumb-item"><a href="insert">Thêm loại phòng mới</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-md-12" >
                                    <form action="insert" method="POST">
                                        <table class="table table-striped" style="border: 1px solid black;">
                                            <tr>
                                                <th scope="row">Tên loại phòng: </th>
                                                <td><input style="border: 1px solid black;" name="name" type="text" class="form-control" placeholder="Tên loại phòng" aria-describedby="basic-addon1"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Giá: </th>
                                            ...
                                            <tr>
                                                <th scope="row">Số người ở tối đa: </th>
                                                <td><input style="border: 1px solid black;" name="people" type="text" class="form-control" placeholder="Số người ở tối đa" aria-describedby="basic-addon1"></td>
                                            </tr>
                                            <tr>
