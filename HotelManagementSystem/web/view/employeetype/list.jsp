                    ...
                    <ul class="nav pcoded-inner-navbar">
                        ...
                        <li class="nav-item pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li class=""><a href="list" class="">Vị trí nhân sự</a></li>
                    ...
                    <li class="nav-item">
                        <div class="main-search open">
                            <div class="input-group">
                                <form action="../employeetype/search" method="POST">
                                    <div class="row">
                                        <div>
                            ...
                            <div class="page-wrapper">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="page-header-title">
                                                    <h5>Vị trí nhân sự</h5>
                                                </div>
                                                <ul class="breadcrumb">
                                                    <li class="breadcrumb-item"><a href="../admin/home"><i class="feather icon-home"></i></a></li>
                                                    <li class="breadcrumb-item"><a href="list">Quản lý các vị trí của nhân sự</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div style="margin-bottom: 20px;">
                                    <button type="button" class="btn btn-primary">
                                        <a href="../employeetype/insert" style="text-decoration: none;color: white;">Thêm vị trí nhân sự mới</a></button>
                                </div>
                                <!-- [ breadcrumb ] end -->
                                <!-- [ Main Content ] start -->
                                <div class="col-xl-12 col-md-12">
                                    <div class="card table-card">
                                        <div class="card-header">
                                            <h5>Danh sách vị trí nhân sự</h5>
                                        </div>
                                                ...
                                                <div class="session-scroll" style="height:478px;position:relative;">
                                                    <table class="table table-hover m-b-0">
                                                        <thead>
                                                            <tr>
                                                                <th><span>STT</span></th>
                                                                <th><span>Tên vị trí nhân sự</span></th>
                                                                <th><span>Sửa</span></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button type="button" class="btn btn-primary"><a style="text-decoration: none;color: white;" href="../employeetype/update?etID=<%=list.get(i).getID() %>">Sửa</a></button></td> 
                                                            </tr>
                                                            <%
                                                                }
                                                            %>
