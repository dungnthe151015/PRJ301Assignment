                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <ul class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item">Sửa thông tin của phòng</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="update" method="POST">
                                        ...
                                        <table class="table table-striped" style="border: 1px solid black;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="status">
                                                        <option value="true" ${r.isStatus() == true ? "selected":""}>Còn phòng</option>
                                                        <option value="false" ${r.isStatus() == false ? "selected":""}>Hết phòng</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
